...
hljs.registerLanguage("halcyon", function (hljs) {
  return {
    name: "Halcyon",
    ...
    contains: [
      ...
      //  *)
      {
        ...
        contains: [
          {
            begin: /^\s*\*/, // highlight leading '*' at line start
            relevance: 0
          }
        ]
      },
      // Strings: "..."
      {
        ...
        contains: [{ begin: '\\\\.' }] // handle escape sequences
      },
      {
        className: "string",
        begin: "'",
      ...
      {
        className: "function",
        begin: /\blet\s+[a-zA-Z_]\w*\s*=\s*fn\b/,
        end: /=>/,
        excludeEnd: true,
        keywords: "let fn",
        contains: [
      ...
      // --- General let-bindings: let name = expr
      {
        begin: /\blet\s+[a-zA-Z_]\w*/,
        keywords: "let",
        className: "variable"
